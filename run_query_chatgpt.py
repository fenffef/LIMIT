...
import time
from tqdm import *
from data_processor import RocProcessor
...
class ChatGPT4CSC(object):
    def __init__(self,key_file,message_file=None, prompt_examples = None, key_id=0):
        ...
        self.prefix = "请修改句子中的拼写错误，如果句子中没有错误，请直接照抄原句。\n"
        self.icl_prompt = ""
    ...
    def gptCorrect(self,src):
        ...
        return result.choices[0].message.content ## the response of chatgpt
...
def main():
    ...
    parser.add_argument("--key_file",type=str,default="../envs/openai_key.json",help="the file containing the api key")
    parser.add_argument("--message_file",type=str,default="../model/message_law.json",help="the file to store the chat messages")
    parser.add_argument("--data_dir", type=str, default="../data/",
                        help="Directory to contain the input data for all tasks.")
    parser.add_argument("--task_name", type=str, default="ecspell",
                        help="Name of the training task.")
    parser.add_argument("--train_on", type=str, default="hybrid",help="Choose a set where the few shot learning examples come from")
    parser.add_argument("--test_on", type=str, default="hybrid",help="Choose a dev set.")
