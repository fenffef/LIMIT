...
def process_data(data_bundle, args):
    ...
    def truncate_src_id(instance, max_len):
        if len(instance[source]) > max_len:
            if args.PTM == "bart":
                return instance[source][:max_len - 1] + [args.pad_id]
            else:
...
def get_data_bundle(args):
    ...
    if args.PTM == "codet5":
        ...
        if "mengzi" in args.model_name:
            ...
            tokenizer_name = "t5-robust"
    elif args.PTM == "pegasus":
        tokenizer_name = "/media/HD0/LIMIT/pegasus-base-chinese-cluecorpussmall"
    elif args.PTM == "bart":
    ...
    print("pad_id:", args.pad_id)
    print("eos_id:", args.eos_id)
    print("bos_id:", args.bos_id)

    if args.PTM == "bart":
        args.sep_id = tokenizer.sep_token_id
        print("sep_id:", args.sep_id)
