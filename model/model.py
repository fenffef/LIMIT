...
class LIMITGenerator(nn.Module):

    def __init__(self, PTM, model_name, pad_id, args):
        super(LIMITGenerator, self).__init__()
        self.PTM = PTM
        if self.PTM == "pegasus":
    ...
    def torch_bleu(self, ref_tensor, sys_tensor, pad_id, n_gram=2):
        """
        Calculates n-gram precision with brevity penalty. LIMITributed by jinulee-v
    ...
    def forward(self, src_inp, target_inp, target_outp):
        ...
        """
        # print("src_inp:", src_inp)
        # print("target_inp:", target_inp)
        # print("target_outp:", target_outp)
